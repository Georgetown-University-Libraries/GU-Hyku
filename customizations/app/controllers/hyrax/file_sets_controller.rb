    ...
    def after_update_response
      respond_to do |wants|
        wants.html do
          ...
          #redirect to Work show page instead of than FileSet show page
          redirect_to [main_app, curation_concern.parent], notice: view_context.t('hyrax.file_sets.asset_updated_flash.message', link_to_file: link_to_file)
        end
        wants.json do
