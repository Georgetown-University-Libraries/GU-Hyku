...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_facet_field 'source_tesim', label: "Source", limit: 5
    ...
    config.add_index_field 'source_tesim', itemprop: 'source', label: "Source", link_to_search: 'source_tesim'
