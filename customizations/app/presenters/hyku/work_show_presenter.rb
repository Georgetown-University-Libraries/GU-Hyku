...
module Hyku
  class WorkShowPresenter < Hyrax::WorkShowPresenter
    ...
    def representative_embargo_release_date
    ...
    # returns relation_uri value if sharestream url (e.g., https://mediapilot.georgetown.edu/ssdcms/i.do?u=8607bf3e34ae47f)
    # excludes "auth:" prefix if necessary
    def sharestream_link
      if solr_document["relation_uri_tesim"]&.first&.match?(/mediapilot/)
        solr_document["relation_uri_tesim"]&.first&.gsub(/auth:/, "")
      end
    end 
