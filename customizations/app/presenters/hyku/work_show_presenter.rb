...
module Hyku
    class WorkShowPresenter < Hyrax::WorkShowPresenter
      ...
      # checks if relation_uri value is ShareStream url (e.g., https://mediapilot.georgetown.edu/ssdcms/i.do?u=8607bf3e34ae47f)
      def has_sharestream_link?
        solr_document["relation_uri_tesim"]&.first&.match?(/mediapilot/)
      end 
