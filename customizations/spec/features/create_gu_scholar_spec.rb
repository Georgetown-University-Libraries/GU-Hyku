...
RSpec.feature 'Create a GuScholar', js: false do
  context 'a logged in user' do
    ...
    scenario do
      ...
      # choose "payload_concern", option: "GuScholar"
      # click_button "Create work"

      expect(page).to have_content "Add New Gu scholar"
      ...
      # its element
      find('body').click
      choose('gu_scholar_visibility_open')
