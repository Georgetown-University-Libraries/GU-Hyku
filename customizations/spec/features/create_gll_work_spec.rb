...
RSpec.feature 'Create a GllWork', js: false do
  context 'a logged in user' do
    ...
    scenario do
      ...
      # choose "payload_concern", option: "GllWork"
      # click_button "Create work"

      expect(page).to have_content "Add New Gll work"
      ...
      # its element
      find('body').click
      choose('gll_work_visibility_open')
