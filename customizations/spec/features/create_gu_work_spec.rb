...
RSpec.feature 'Create a GuWork', js: false do
  context 'a logged in user' do
    ...
    scenario do
      ...
      # choose "payload_concern", option: "GuWork"
      # click_button "Create work"

      expect(page).to have_content "Add New Gu work"
      ...
      # its element
      find('body').click
      choose('gu_work_visibility_open')
